...
public class AppServlet extends HttpServlet {
				...
				case "cities": 	int cityID;
								...
								if(currentResource==null)
								{
								    ...
								    if(request.getParameter("sortBy")!=null)
								    {
									    ...
									    else throw new InvalidRequestException("Wrong Sort By Value");
								    }
								...
								else if(CommonUtil.isNumber(currentResource))
								{
									...
									else if(!currentResource.equals("camps")) throw new InvalidRequestException();
									else
									{
										currentResource=resourceQueue.poll();
										...
										else if(!currentResource.equals("slots")) throw new InvalidRequestException();
										else
										{
											...
											else if(!CommonUtil.isNumber(currentResource)) throw new InvalidRequestException();
											else
											{
								...
								break;
				case "people":  currentResource=resourceQueue.poll();
								if(currentResource==null)
								{
									...
									if(request.getParameter("filter")!=null)
									{
										...
										else throw new InvalidRequestException("Invalid Filter Value");
									}
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		{
			JSONObject requestJSON=JSONUtil.toJSON(request);
			if(!CacheDB.cacheExists())
			{
				CacheDB.loadOverallData();
			}
			Queue<String> resourceQueue=CommonUtil.parseRequest(request);
			System.out.print(resourceQueue);
			if(resourceQueue.poll().equals("cities") && resourceQueue.poll().equals("camps") && resourceQueue.poll().equals("slots") && resourceQueue.poll().equals("bookings"))
			{
